...
function create_character() {
    ...
    let output = `<p>You are ${determiner} <span id="adjective">${character_data.adjective}</span> <span id="race">${to_title_case(character_data.race)}</span> <span id="character_class">${to_title_case(character_data.character_class)}</span> from <span id="origin">${character_data.origin}</span> who <span id="who">${character_data.who}</span>.</p>`;
